  ...
  return (
    <main id="main-content" className="overflow-x-clip">
      ...
      <article className="mx-auto w-[min(1180px,calc(100%_-_44px))] py-10 md:py-14">
        ...
        <section className="mt-16 border-t border-line pt-12" aria-labelledby="architecture-title"><SectionHeading eyebrow="07 / SYSTEM DESIGN" id="architecture-title" title="The architecture follows the financial boundaries." intro="LedgerOps is deliberately built as a modular system rather than a collection of unrelated services. Modules own their data and communicate through published interfaces or durable messages, while PostgreSQL remains the transactional source of truth." /><DiagramShell className="mx-auto max-w-5xl" label="FIG 09" title="System architecture" caption="Architecture is supporting evidence after the Payment and financial model are understood."><ArchitectureFigure /></DiagramShell></section>
